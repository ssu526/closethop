...
public class ClothingItem {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "processing_status", nullable = false, columnDefinition = "varchar(32) default 'PROCESSING'")
    @Builder.Default
    private Enums.ProcessingStatus status = Enums.ProcessingStatus.PROCESSING;

    @Column(name = "processing_error")
    private String processingError;

    @Column(name = "processing_version", nullable = false, columnDefinition = "integer default 1")
    @Builder.Default
    ...
    @Column(name = "upload_hash", length = 64)
